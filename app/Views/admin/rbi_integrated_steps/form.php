...
<div class="card">
    <div class="card-header">
        <h3 class="mb-0"><?= isset($item) ? 'Edit' : 'Add' ?> Step</h3>
    </div>
    <div class="card-body">
        <form method="post" action="<?= isset($item) ? base_url('admin/rbi-integrated-steps/update/'.$item['id']) : base_url('admin/rbi-integrated-steps/store') ?>">
            <?= csrf_field() ?>
            <div class="mb-3">
                ...
                <small class="text-muted d-block">Example: 1, 2, 3</small>
            </div>
            <div class="mb-3">
            ...
            <a href="<?= base_url('admin/rbi-integrated-steps') ?>" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
</div>
