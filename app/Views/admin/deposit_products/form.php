...
<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="<?= isset($item) ? base_url('admin/deposit-products/update/'.$item['id']) : base_url('admin/deposit-products/store') ?>">
            <?= csrf_field() ?>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="min_amount" class="form-control" value="<?= old('min_amount', $item['min_amount'] ?? '') ?>" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="payout" class="form-control" value="<?= old('payout', $item['payout'] ?? '') ?>" required>
            </div>
            <div class="mb-3">
