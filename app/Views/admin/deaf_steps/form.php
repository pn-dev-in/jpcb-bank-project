...
<div class="card">
    <div class="card-header">
        <h3 class="mb-0"><?= isset($item) ? 'Edit' : 'Add' ?> DEAF Step</h3>
    </div>
    <div class="card-body">
        <form method="post" action="<?= isset($item) ? base_url('admin/deaf-steps/update/'.$item['id']) : base_url('admin/deaf-steps/store') ?>">
            <?= csrf_field() ?>
            <div class="row mb-3">
                <div class="col-md-6">
            ...
            <a href="<?= base_url('admin/deaf-steps') ?>" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
</div>
