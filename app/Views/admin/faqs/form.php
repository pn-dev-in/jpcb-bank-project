...
<div class="card">
    <div class="card-header">
        <h3 class="mb-0"><?= isset($item) ? 'Edit' : 'Add' ?> FAQ</h3>
    </div>
    <div class="card-body">
        <form method="post" action="<?= isset($item) ? base_url('admin/faqs/update/'.$item['id']) : base_url('admin/faqs/store') ?>">
            <?= csrf_field() ?>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="answer" class="form-control" rows="5" required><?= old('answer', $item['answer'] ?? '') ?></textarea>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
