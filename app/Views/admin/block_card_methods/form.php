...
<div class="card">
    <div class="card-header">
        <h3 class="mb-0"><?= isset($item) ? 'Edit' : 'Add' ?> Block Card Method</h3>
    </div>
    <div class="card-body">
        <form method="post" action="<?= isset($item) ? base_url('admin/block-card-methods/update/'.$item['id']) : base_url('admin/block-card-methods/store') ?>">
            <?= csrf_field() ?>
            <div class="mb-3">
            ...
            <a href="<?= base_url('admin/block-card-methods') ?>" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
</div>
