...
<div class="card">
    <div class="card-header">
        <h3 class="mb-0"><?= isset($item) ? 'Edit' : 'Add' ?> Registration Step</h3>
    </div>
    <div class="card-body">
        <form method="post" action="<?= isset($item) ? base_url('admin/mobile-registration-steps/update/'.$item['id']) : base_url('admin/mobile-registration-steps/store') ?>">
            <?= csrf_field() ?>
            <div class="mb-3">
            ...
            <a href="<?= base_url('admin/mobile-registration-steps') ?>" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
</div>
