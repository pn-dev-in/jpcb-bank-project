...
<div class="card">
    <div class="card-header">
        <h3 class="mb-0"><?= isset($item) ? 'Edit' : 'Add' ?> Digital Service</h3>
    </div>
    <div class="card-body">
        <form method="post" action="<?= isset($item) ? base_url('admin/digital-services/update/'.$item['id']) : base_url('admin/digital-services/store') ?>">
            <?= csrf_field() ?>
            <div class="mb-3">
