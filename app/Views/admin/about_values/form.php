...
<div class="card">
    <div class="card-header">
        <h3 class="mb-0"><?= isset($item) ? 'Edit' : 'Add' ?> Value</h3>
    </div>
    <div class="card-body">
        <form method="post" action="<?= isset($item) ? base_url('admin/about-values/update/'.$item['id']) : base_url('admin/about-values/store') ?>">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <small class="text-muted d-block">Examples: shield, users, trending-up, heart, etc.</small>
            </div>
            ...
            <a href="<?= base_url('admin/about-values') ?>" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
</div>
