...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h3 class="mb-0">Gallery Categories</h3>
    <a href="<?= base_url('admin/gallery-categories/create') ?>" class="btn btn-primary btn-sm">+ Add New Category</a>
</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="<?= base_url('admin/gallery-categories/delete/'.$item['id']) ?>" method="post" class="d-inline">
                                <?= csrf_field() ?>
