...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mt-1">Grant or revoke module‑level permissions. Hover over any action for a detailed
                description.</p>
        </div>
            ...
            <div class="card-body py-3">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-md-6 text-md-end">
                        <span class="badge bg-light text-dark me-2"><i class="ti ti-info-circle"></i> Grey rows = no
                            permissions</span>
                        <span class="badge bg-light-primary text-primary"><i class="ti ti-checkbox"></i> Blue rows = at
                            least one permission</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="accordion" id="permAccordion">
            ...
            $categories = [
                ...
                'Digital Payments' => [
                    ...
                    'atm_obtain_steps' => 'ATM How to Obtain',
                ...
                <div class="accordion-item mb-3 border-0 shadow-sm">
                    <h2 class="accordion-header" id="heading<?= $accordionIndex ?>">
                        <button class="accordion-button <?= $collapsed ?> bg-light text-dark fw-semibold" type="button"
                            ...
                            <i class="ti ti-folder-open me-2"></i> <?= $categoryName ?> <span
                                class="badge bg-secondary ms-2"><?= count($modules) ?> modules</span>
                        </button>
                    </h2>
                    <div id="collapse<?= $accordionIndex ?>" class="accordion-collapse collapse <?= $show ?>"
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <?php foreach ($modules as $moduleKey => $moduleLabel):
                                            ...
                                            ?>
                                            <tr class="module-row <?= $hasAny ? 'table-primary' : '' ?>"
                                                data-module-key="<?= $moduleKey ?>" data-category="<?= $accordionIndex ?>">
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ($permId): ?>
                                                            <div class="form-check justify-content-center d-flex">
                                                                <input type="checkbox"
                                                                    class="form-check-input perm-checkbox <?= $moduleKey ?>-perm"
                                                                    name="permissions[]" value="<?= $permId ?>" <?= $checked ?>>
                                                            </div>
                                                        <?php else: ?>
