...
<div class="card">
    <div class="card-header">
        <h3 class="mb-0"><?= isset($item) ? 'Edit' : 'Add' ?> Deposit Card</h3>
    </div>
    <div class="card-body">
        <form method="post" action="<?= isset($item) ? base_url('admin/deposit-cards/update/'.$item['id']) : base_url('admin/deposit-cards/store') ?>">
            <?= csrf_field() ?>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label class="form-label">Link (relative URL, e.g., /deposits/savings-current)</label>
