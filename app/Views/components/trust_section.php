<section id="trust" class="section-padding section-alt" aria-labelledby="trust-heading">
  <div class="container-bank">
    ...
    <!-- Stats Grid -->
    <div class="trust-stats-grid mb-10">
  <?php foreach ($trustStats as $stat): ?>
    <?php if (!empty($stat['link'])): ?>
      <a href="<?= esc($stat['link']) ?>" target="_blank" rel="noopener noreferrer" class="text-center block transition-transform hover:scale-105">
    <?php else: ?>
