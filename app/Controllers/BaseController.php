...
abstract class BaseController extends Controller
{
    ...
    public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger)
    {
        ...
        $this->helpers = ['url', 'log', 'form', 'translation'];
        ...
        service('renderer')->setVar('currentLanguage', current_site_language());
        service('renderer')->setVar('availableLanguages', site_languages());
