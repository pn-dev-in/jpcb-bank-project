...
use App\Models\DeafStepModel;

class DeafSteps extends BaseController
{
    protected $model;

    public function __construct()
    {
        $this->model = new DeafStepModel();
    }

    public function index()
    {
        $data['items'] = $this->model->orderBy('sort_order', 'asc')->findAll();
        return view('admin/deaf_steps/index', $data);
    }

    public function create()
    {
        return view('admin/deaf_steps/form');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$item) return redirect()->to('/admin/deaf-steps')->with('error', 'Not found.');
        return view('admin/deaf_steps/form', ['item' => $item]);
    }
